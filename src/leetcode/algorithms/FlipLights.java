...
public class FlipLights {
    ...
    public static int flipLights(int n, int m) {
        ...
        for (int i = 1; i <= n; i++) {
            /**
             * 第1、5、6、7、11、12、13、14种奇偶序列第1个开关被按了奇数次，会改变第i盏灯的状态
             */
            ...
            /**
             * 第2、5、8、9、11、12、14、15种奇偶序列第2个开关被按了奇数次，会改变第i=2k(k∈N+)盏灯的状态
             */
            if (i % 2 == 0) {
            ...
            /**
             * 第3、6、8、10、11、13、14、15种奇偶序列第3个开关被按了奇数次会改变第i=2k+1(k∈N)盏灯的状态
             */
            if (i % 2 == 1) {
            ...
            /**
             * 第4、7、9、10、12、13、14、15种奇偶序列第4个开关被按了奇数次会改变第i=3k+1(k∈N)盏灯的状态
             */
            if ((i - 1) % 3 == 0) {
