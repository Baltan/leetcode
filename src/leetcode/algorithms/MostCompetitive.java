...
public class MostCompetitive {
    public static void main(String[] args) {
        OutputUtils.print1DIntegerArray(mostCompetitive(new int[]{3, 5, 2, 6}, 2));
        OutputUtils.print1DIntegerArray(mostCompetitive(new int[]{2, 4, 3, 3, 5, 4, 9, 6}, 4));
        OutputUtils.print1DIntegerArray(
                mostCompetitive(new int[]{84, 10, 71, 23, 66, 61, 62, 64, 34, 41, 80, 25, 91, 43
                        , 4, 75, 65, 13, 37, 41, 46, 90, 55, 8, 85, 61, 95, 71}, 24));
        OutputUtils.print1DIntegerArray(mostCompetitive(
