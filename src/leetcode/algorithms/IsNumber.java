...
public class IsNumber {
    public static void main(String[] args) {
        /**
         * 测试用例参考：
         * <a href="https://leetcode-cn.com/problems/valid-number/solution/xiang-xi-tong-su-de-si-lu-fen-xi-duo-jie-fa-by-1-4/"></a>
         */
    ...
    public static boolean isNumber(String s) {
        ...
        /**
         * 统计字符串s中指定类型的字符出现的次数：
         * charStatistics[0]：0-9的数量，charStatistics[1]："e"的数量，charStatistics[2]："."
        ...
        /**
         * 如果字符串s中包含除0-9、"±"、"."、"e"之外的无效字符，则s是一个无效字符串，直接返回false
         */
        if (charStatistics[4] > 0) {
            return false;
        }
        /**
         * 如果s中包含多余一个"e"，则s是一个无效字符串，直接返回false
         */
        ...
        if (charStatistics[1] == 0) {
            /**
             * 如果s中不包含"e"，并且s中含有"±"或者s为"."，则s是一个无效字符串，直接返回false，除去
             * 这两中情况外s是有效的整数或小数字符串
             */
            ...
            /**
             * 如果s中包含"e"，并且s以e打头或结尾，则s是一个无效字符串，直接返回false
             */
